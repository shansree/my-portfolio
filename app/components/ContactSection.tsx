			...
			<div className="max-w-2xl mx-auto">
				<motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center space-y-6">
					...
					<div className="flex flex-col sm:flex-row justify-center gap-4">
						<a
							href="mailto:shansree006@gmail.com"
						...
						<a
							href="/sreekumar_frontenddev_resume.pdf"
							target="_blank"
					...
					<div className="flex justify-center gap-6">
						<a href="https://github.com/shansree" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
						...
						<a href="https://www.linkedin.com/in/sreekumar-d-650b23218/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-400 transition-colors">
							<svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
