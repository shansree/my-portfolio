...
export const metadata: Metadata = {
	title: 'SREEKUMAR D - Full Stack Developer',
	description:
	...
	authors: [{ name: 'SREEKUMAR D' }],
	creator: 'SREEKUMAR D',
	openGraph: {
		title: 'SREEKUMAR D - Developer Portfolio',
		...
		siteName: 'SREEKUMAR D - Portfolio',
		images: [
			{
				url: '/og-image.jpg',
				width: 1200,
				height: 630,
				alt: 'SREEKUMAR D - Developer Portfolio',
			},
		],
		locale: 'en_US',
		type: 'website',
